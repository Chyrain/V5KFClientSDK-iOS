...
/** Represents the results of executing a query on an `<V5FMDatabase>`.
...
@interface V5FMResultSet : NSObject {
    V5FMDatabase          *_parentDB;
    V5FMStatement         *_statement;
...
/** `V5FMStatement` used by result set. */

@property (atomic, retain) V5FMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<V5FMStatement>`
 
 @param statement A `<V5FMStatement>` to be performed
 
 @param aDB A `<V5FMDatabase>` to be used
 
 @return A `V5FMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(V5FMStatement *)statement usingParentDatabase:(V5FMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(V5FMDatabase *)newDb;
