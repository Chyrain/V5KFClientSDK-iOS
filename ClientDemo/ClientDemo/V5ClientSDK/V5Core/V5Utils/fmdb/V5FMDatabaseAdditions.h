...
/** Category of additions for `<V5FMDatabase>` class.
...
@interface V5FMDatabase (V5FMDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `V5FMDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `V5FMResultSet` of schema; `nil` on error.
